...
class MockCommunityRepository implements CommunityRepository {
  ...
  final List<PostModel> _posts = [
    PostModel(
      ...
      title: 'How did you prepare for scholarship essays?',
      content: 'I am collecting practical advice for writing a strong personal statement.',
      topic: 'Scholarships',
    ...
    PostModel(
      ...
      title: 'What made your internship application stand out?',
      content: 'Sharing notes on portfolios, project descriptions, and interview preparation.',
      topic: 'Internships',
    ...
    PostModel(
      ...
      title: 'Finding mentors in biotechnology',
      content:
          'Which communities helped you connect with researchers and labs?',
      topic: 'Biotech',
    ...
    PostModel(
      ...
      authorRole: 'Business student',
      title: 'Skills worth learning this semester',
      content: 'I am choosing between analytics, finance, and product management electives.',
      topic: 'Career Advice',
  ...
  final Map<String, List<CommentModel>> _comments = {
    'p1': [
      CommentModel(
        ...
        postId: 'p1',
        authorId: 'u5',
        authorName: 'Nida Ahmed',
        content: 'Start with one specific moment and connect it to your goals.',
  ...
  @override
  Future<List<PostModel>> getPosts({String? topic}) async => _posts
      .where(
        (post) =>
            post.status == PostStatus.approved &&
            (topic == null || post.topic == topic),
      )
      .toList();
  ...
  Future<PostModel> toggleFollowAuthor(String postId) async {
    final index = _posts.indexWhere((post) => post.id == postId);
    _posts[index] = _posts[index].copyWith(
      isFollowingAuthor: !_posts[index].isFollowingAuthor,
    );
    return _posts[index];
  }
  ...
  Future<PostModel> updateUniversityPost(
    ...
    if (index < 0 ||
        _posts[index].authorType != 'university' ||
        _posts[index].universityId != universityId) {
