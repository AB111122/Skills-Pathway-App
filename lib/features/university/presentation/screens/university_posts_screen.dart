...
class UniversityPostsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UniversityPostsScreen> createState() =>
      _UniversityPostsScreenState();
}
...
class _UniversityPostsScreenState extends ConsumerState<UniversityPostsScreen> {
  ...
  void _reload() {
    ...
    _posts = ref
        ...
        .getPostsByAuthor(organizationId);
  }
      ...
      builder: (context, snapshot) {
        ...
        return ListView(
          ...
          children: [
            ElevatedButton.icon(
              onPressed: () async {
                await context.push('/university/posts/create');
            ...
            ...posts.map(
              (post) => Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                    '${post.topic} | ${post.likesCount + post.commentsCount} engagement',
                  ),
                    ...
                    onSelected: (action) async {
                      ...
                      if (action == 'delete') {
                        ...
                        if (confirmed == true) {
                          await ref
                              .read(communityRepositoryProvider)
                              .deleteUniversityPost(organizationId, post.id);
                          if (context.mounted) setState(_reload);
                        }
                      }
                    },
